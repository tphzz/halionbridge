...
local layerName = "000 Release 0p25"
local outputFile = "000_release_0p25.vstpreset"
...
local regions = {
    {
        name = "amp_env_loop",
        sample_playback = {
            sample = "C:/develop/halionbridge/probes/sfz/048-amplitude-release-two-segment-implementation-regression/source/samples/amp_env_loop.wav",
        },
        mapping = {
            key_low = 57,
            key_high = 57,
        ...
        amp_envelope = {
            points = {
                ...
                { level = 1, duration = 0, curve = 0 },
                { level = 0.349999994, duration = 0.0242500007, curve = -0.239999995 },
                { level = 0, duration = 0.126749992, curve = -1 },
            },
            sustain_index = 3,
        },
        loop = {
