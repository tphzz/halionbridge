...
local layerName = "003 Release 2p00"
local outputFile = "003_release_2p00.vstpreset"
...
local regions = {
    {
        ...
        amp_envelope = {
            points = {
                ...
                { level = 1, duration = 0, curve = 0 },
                { level = 0.349999994, duration = 0.194000006, curve = -0.239999995 },
                { level = 0, duration = 1.01399994, curve = -1 },
            },
            sustain_index = 3,
        },
        loop = {
