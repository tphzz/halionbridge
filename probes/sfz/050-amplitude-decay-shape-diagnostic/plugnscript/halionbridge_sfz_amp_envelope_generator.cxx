/** \file
*   Deterministic MIDI probe for HALion amplitude-envelope checks.
*
*   Load this Blue Cat Plug'n Script script before either sforzando or HALion.
*   It emits note 57 at full velocity, holds it long enough for delay, attack,
*   hold, and decay cases to settle, then leaves a long release gap.
*/

string name = "halionbridge SFZ amp envelope generator";
string description = "Emits fixed notes for SFZ amplitude envelope checks";

const int channel = 1;
const int note = 57;
const int velocity = 127;
const double leadInSeconds = 1.0;
const double noteDurationSeconds = 3.5;
const double cycleGapSeconds = 4.0;
