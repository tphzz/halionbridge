...
local layerName = "002 End 22049 Impulse 22049"
local outputFile = "002_end_22049_impulse_22049.vstpreset"
...
local regions = {
    {
        name = "impulse_at_22049",
        sample_playback = {
            sample = "C:/develop/halionbridge/probes/sfz/038-sample-playback-range-implementation-regression/source/samples/impulse_at_22049.wav",
            finish = 22049,
        },
        mapping = {
            key_low = 57,
