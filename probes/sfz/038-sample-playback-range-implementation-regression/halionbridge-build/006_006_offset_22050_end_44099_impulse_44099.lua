...
local layerName = "006 Offset 22050 End 44099 Impulse 44099"
local outputFile = "006_offset_22050_end_44099_impulse_44099.vstpreset"
...
local regions = {
    {
        name = "impulse_at_44099",
        sample_playback = {
            sample = "C:/develop/halionbridge/probes/sfz/038-sample-playback-range-implementation-regression/source/samples/impulse_at_44099.wav",
            offset = 22050,
            finish = 44099,
        },
        mapping = {
