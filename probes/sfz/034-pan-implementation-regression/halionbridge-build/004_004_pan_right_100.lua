...
local layerName = "004 Pan Right 100"
local outputFile = "004_pan_right_100.vstpreset"
...
local regions = {
    {
        ...
        sample_playback = {
            sample = "C:/develop/halionbridge/probes/sfz/034-pan-implementation-regression/source/samples/sine_A3_single_cycle.wav",
        },
        mapping = {
            key_low = 57,
            key_high = 57,
