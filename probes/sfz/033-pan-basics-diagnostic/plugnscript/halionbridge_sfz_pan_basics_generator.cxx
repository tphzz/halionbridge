/** \file
*   Deterministic MIDI probe for halionbridge SFZ pan checks.
*
*   Load this Blue Cat Plug'n Script script before either sforzando or HALion.
*   It repeatedly plays the probe root note at velocity 127. Use stereo meters,
*   phase inversion, or ear comparison to check pan behavior.
*/

string name = "halionbridge SFZ pan basics generator";
string description = "Emits a fixed note for static pan checks";

const int channel = 1;
const int note = 57;
const int velocity = 127;
const double leadInSeconds = 1.0;
const double noteDurationSeconds = 2.0;
