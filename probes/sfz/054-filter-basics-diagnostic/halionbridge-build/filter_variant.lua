...
local samplePath = "C:/develop/halionbridge/probes/sfz/054-filter-basics-diagnostic/source/samples/saw_A3_single_cycle.wav"
...
local function filter_params(config)
    ...
    if config.velocity_to_cutoff ~= nil then
        params[#params + 1] = { "Filter.VelocityToCutoff", config.velocity_to_cutoff }
    end
    return params
end
