...
local samplePath = "C:/develop/halionbridge/probes/sfz/046-amplitude-release-duration-scale-diagnostic/source/samples/amp_env_loop.wav"
    ...
    local regions = {
        {
            ...
            amp_envelope = {
                points = {
                    ...
                    { level = 1, duration = 0, curve = 0 },
                    { level = 0, duration = releaseDuration, curve = -1.0 },
                },
                sustain_index = 3,
            },
            loop = {
