...
local layerName = "001 Pitch Keycenter 69 Root Shift"
local outputFile = "001_pitch_keycenter_69_root_shift.vstpreset"
...
local regions = {
    {
        ...
        sample_playback = {
            sample = "C:/develop/halionbridge/probes/sfz/025-static-pitch-tuning-implementation-regression/source/samples/sine_A3_single_cycle.wav",
        },
        mapping = {
            key_low = 48,
            key_high = 84,
