...
local layerName = "001 Volume Minus 6"
local outputFile = "001_volume_minus_6.vstpreset"
...
local regions = {
    {
        ...
        sample_playback = {
            sample = "C:/develop/halionbridge/probes/sfz/032-gain-velocity-implementation-regression/source/samples/sine_A3_single_cycle.wav",
        },
        mapping = {
            key_low = 57,
            key_high = 57,
        ...
        gain = {
            sample_osc_level_db = 1.80000019,
