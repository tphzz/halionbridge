/** \file
*   Deterministic MIDI probe for halionbridge SFZ gain and amp velocity tracking.
*
...
string name = "halionbridge SFZ gain velocity implementation generator";
string description = "Emits fixed velocities for volume and amp_veltrack implementation checks";
