/** \file
*   Deterministic MIDI probe for long SFZ loop-mode checks.
*
...
*   The long hold makes loop mode stable before note-off; the long release/gap
*   makes loop_continuous versus loop_sustain behavior audible.
*/

string name = "halionbridge SFZ long loop generator";
string description = "Emits a long fixed note for clean loop mode checks";
