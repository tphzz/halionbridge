...
local layerName = "004 VelocityToLevel 200 Amp +7.8"
local outputFile = "004_velocity_to_level_200_amp_plus_7p8.vstpreset"
...
return function(ctx)
    ...
    hb.set_parameter_if_available(ctx, zone, "Amp.Level", 7.8)
