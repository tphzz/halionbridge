/** \file
*   Deterministic MIDI probe for halionbridge SFZ gain, pan, and amp velocity tracking.
*
...
string name = "halionbridge SFZ gain pan velocity generator";
string description = "Emits fixed velocities for volume, pan, and amp_veltrack checks";
