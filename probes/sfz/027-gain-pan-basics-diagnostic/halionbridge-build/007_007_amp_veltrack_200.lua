...
local layerName = "007 Amp Veltrack 200"
local outputFile = "007_amp_veltrack_200.vstpreset"
...
local regions = {
    {
        ...
        sample_playback = {
            sample = "C:/develop/halionbridge/probes/sfz/027-gain-pan-basics-diagnostic/source/samples/sine_A3_single_cycle.wav",
        },
        mapping = {
            key_low = 57,
            key_high = 57,
