...
local layerName = "014 Hpf 2p Sv"
local outputFile = "014_hpf_2p_sv.vstpreset"
...
local regions = {
    {
        ...
        sample_playback = {
            sample = "C:/develop/halionbridge/probes/sfz/060-filter-family-implementation-regression/source/samples/saw_A3_single_cycle.wav",
        },
        mapping = {
            key_low = 57,
            key_high = 57,
