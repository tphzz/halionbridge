/** \file
*   Deterministic MIDI probe for halionbridge SFZ amp velocity curve sweep.
*
...
string name = "halionbridge SFZ amp velocity curve sweep generator";
string description = "Emits fixed velocities for Amp Env.VelocityToLevelCurve checks";
