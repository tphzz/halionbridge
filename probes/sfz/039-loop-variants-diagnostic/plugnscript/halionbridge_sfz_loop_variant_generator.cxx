/** \file
*   Deterministic MIDI probe for halionbridge SFZ loop-variant checks.
*
*   Load this Blue Cat Plug'n Script script before either sforzando or HALion.
*   It repeatedly plays note 57 at velocity 127. The note-off happens after
*   playback has entered the loop, leaving enough release time to expose
*   loop_continuous versus loop_sustain behavior.
*/

string name = "halionbridge SFZ loop variant generator";
string description = "Emits a fixed note for SFZ loop mode/crossfade/tune checks";

const int channel = 1;
const int note = 57;
const int velocity = 127;
const double leadInSeconds = 1.0;
const double noteDurationSeconds = 0.75;
const double cycleGapSeconds = 3.25;
