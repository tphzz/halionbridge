/** \file
*   Deterministic MIDI probe for halionbridge SFZ sample playback range checks.
*
*   Load this Blue Cat Plug'n Script script before either sforzando or HALion.
*   It repeatedly plays note 57 long enough for the segmented test sample to
*   reveal the active start and end boundaries.
*/

string name = "halionbridge SFZ sample playback range generator";
string description = "Emits a fixed note for offset/end boundary checks";

const int channel = 1;
const int note = 57;
const int velocity = 127;
const double leadInSeconds = 1.0;
const double noteDurationSeconds = 3.0;
const double cycleGapSeconds = 1.0;
