...
local probeRoot = "C:/develop/halionbridge/probes/sfz/037-sample-end-boundary-impulse/source/samples/"
...
return function(config)
    ...
    local region = {
        ...
        sample_playback = {
            sample = probeRoot .. config.sample_name .. ".wav",
        },
        mapping = {
            key_low = 57,
            key_high = 57,
        ...
        amp_envelope = {
            points = {
                ...
                { level = 1, duration = 0, curve = 0 },
                { level = 0, duration = 0.001, curve = 0 },
            },
            sustain_index = 3,
        },
        gain = {
