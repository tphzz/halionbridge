/** \file
*   Deterministic MIDI probe for halionbridge SFZ Main velocity curve sweep.
*
...
string name = "halionbridge SFZ Main velocity curve sweep generator";
string description = "Emits fixed velocities for Main VelocityToLevelCurve checks";
