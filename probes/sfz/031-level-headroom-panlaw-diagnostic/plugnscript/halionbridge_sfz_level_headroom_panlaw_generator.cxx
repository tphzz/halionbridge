/** \file
*   Deterministic MIDI probe for halionbridge SFZ level/headroom/pan-law checks.
*
...
string name = "halionbridge SFZ level headroom panlaw generator";
string description = "Emits fixed velocities for static level, headroom, and pan-law checks";
