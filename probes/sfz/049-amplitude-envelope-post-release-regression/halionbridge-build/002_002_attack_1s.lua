...
local layerName = "002 Attack 1s"
local outputFile = "002_attack_1s.vstpreset"
...
local regions = {
    {
        ...
        amp_envelope = {
            points = {
                ...
                { level = 0.349999994, duration = 0.0485000014, curve = -0.239999995 },
                { level = 0, duration = 0.253499985, curve = -1 },
            },
            sustain_index = 3,
        },
        loop = {
