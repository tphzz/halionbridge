...
local regions = {
    {
        name = "amp_env_loop",
        sample_playback = {
            sample = "C:/develop/halionbridge/probes/sfz/049-amplitude-envelope-post-release-regression/source/samples/amp_env_loop.wav",
        },
        mapping = {
            key_low = 57,
            key_high = 57,
        ...
        amp_envelope = {
            points = {
                ...
                { level = 0.349999994, duration = 0.0873000026, curve = -0.239999995 },
                { level = 0, duration = 0.456299961, curve = -1 },
            },
            sustain_index = 5,
        },
        loop = {
