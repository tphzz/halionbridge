...
local layerName = "003 Lpf2 Cut1000 Res40"
local outputFile = "003_lpf2_cut1000_res40.vstpreset"
...
local regions = {
    {
        ...
        sample_playback = {
            sample = "C:/develop/halionbridge/probes/sfz/058-filter-lpf2-implementation-regression/source/samples/saw_A3_single_cycle.wav",
        },
        mapping = {
            key_low = 57,
            key_high = 57,
