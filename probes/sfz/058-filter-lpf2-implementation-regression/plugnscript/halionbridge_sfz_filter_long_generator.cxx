/** \file
*   Deterministic MIDI probe for static HALion filter checks.
*
*   Load this Blue Cat Plug'n Script script before either sforzando or HALion.
*   It emits a long note 57 at velocity 127 so static filter topology and
*   cutoff calibration can be compared without velocity tracking.
*/

string name = "halionbridge SFZ long filter generator";
string description = "Emits a long fixed note for SFZ filter checks";
