/** \file
*   Deterministic MIDI probe for SFZ pitch/filter envelope checks.
*
*   Load this Blue Cat Plug'n Script script before either sforzando or HALion.
*   It emits a long note 57 at velocity 127 so pitch and filter envelope motion
*   can be compared without keyboard timing or velocity variation.
*/

string name = "halionbridge SFZ pitch/filter envelope generator";
string description = "Emits a long fixed note for SFZ pitch/filter envelope checks";

const int channel = 1;
const int note = 57;
const int velocity = 127;
const double leadInSeconds = 1.0;
const double noteDurationSeconds = 8.0;
