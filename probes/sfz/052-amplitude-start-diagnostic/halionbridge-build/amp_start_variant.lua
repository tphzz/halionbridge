...
local samplePath = "C:/develop/halionbridge/probes/sfz/052-amplitude-start-diagnostic/source/samples/amp_env_loop.wav"
    ...
    local regions = {
        {
            ...
            amp_envelope = {
                points = {
                    { level = config.start_level, duration = 0, curve = 0 },
